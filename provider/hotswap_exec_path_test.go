...
// TODO: hotswap_exec_path_test.go tests are already present in hotswap_test.go
// (withExecutableEnv and all TestHotSwapExecutablePath* functions are duplicated).
// This file is kept for reference but skipped during compilation.
