...
func startProxyBenchmarks(ctx context.Context, bw *bandwidth.ProxyBandwidth, settings *connect.ProxySettings) {
...
func runTCPLatencyProbe(ctx context.Context, bw *bandwidth.ProxyBandwidth, addr string, interval time.Duration, jitter time.Duration) {
...
func runSocksLatencyProbe(ctx context.Context, bw *bandwidth.ProxyBandwidth, settings *connect.ProxySettings, endpoint string, interval time.Duration, jitter time.Duration) {
