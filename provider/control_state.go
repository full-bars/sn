...
// DESIGN ADAPTATION: Ported from fork package main to package provider.
// Manages runtime control state and persistence in ~/.urnetwork/provider_state.json.
// No external connect symbols are required; state envelope serialization and
// atomic persistence use Go standard library packages.
