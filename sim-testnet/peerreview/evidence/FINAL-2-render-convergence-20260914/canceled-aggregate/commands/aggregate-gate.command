...
set -euo pipefail
umask 077
runtime='/home/by/urnetwork/temp/sn-runtime-render-convergence-20260914/terra-runtime/capture-bounded-20260914T053651Z/aggregate-e3123685'
...
exec env TMPDIR="$runtime/tmp" RELEASE_GATE_CONCURRENT_GATES=2 RELEASE_GATE_JOBS=2 RUN_SERVER_DB_TESTS=1 RELEASE_GATE_DIAGNOSTIC=0 bash "$FINAL_WORKSPACE/sn/scripts/test-release-1.0-local.sh"
