...
set -u -o pipefail
umask 077
runtime='/home/by/urnetwork/temp/sn-runtime-render-convergence-20260914/terra-runtime/capture-bounded-20260914T053651Z/producer-e3123685-globalmodcache'
capture_root="$runtime/capture"
command_file="$runtime/producer-gate.command"
