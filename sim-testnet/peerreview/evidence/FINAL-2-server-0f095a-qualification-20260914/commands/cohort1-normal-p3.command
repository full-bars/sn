...
runtime=/home/by/urnetwork/temp/sn-server-migration-monitor-qualification-20260913/runtime/server-0f095a-v1/cohort1-normal-p3
...
if (( fence_status == 0 )); then
  if [[ -f /home/by/urnetwork/temp/sn-server-migration-monitor-qualification-20260913/runtime/server-0f095a-v1/cohort1-normal-p2/outer/outer.exit && "$(< /home/by/urnetwork/temp/sn-server-migration-monitor-qualification-20260913/runtime/server-0f095a-v1/cohort1-normal-p2/outer/outer.exit)" == 0 && -f "$binary.sha256" ]]; then
