...
set -euo pipefail
umask 077
base=/home/by/urnetwork/temp/sn-runtime458-history-capacity-20260914
runtime="$base/terra-runtime/renderer-cli-runtime458-df98472-r1"
...
expected_sn=df98472bd88dc8e29856c172fba4731d52a6308d
snapshot() {
  ...
  for repo in sn server operator-proxy connect sdk glog goidenticons proxy userwireguard vault xops config warp; do
    ...
    case "$repo" in
      sn) want=df98472bd88dc8e29856c172fba4731d52a6308d; want_physical="$base/sn" ;;
      ...
      xops) want=446cbdb56e0dc5004b66d7e0cbf05a4d9c49224c; want_physical=/home/by/urnetwork/temp/xops-runtime458-pin-20260914/xops ;;
      ...
      warp) want=7498864c7cd3605aad3c43eabfab9008ed7f7228 ;;
    esac
