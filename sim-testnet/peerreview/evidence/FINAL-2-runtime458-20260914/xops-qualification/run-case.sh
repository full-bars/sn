...
printf "%s\n" "$$" > "$case_dir/owner.pid"
{
  ...
  printf 'cwd=%s\n' "$source_root/main/ansible/tests"
  ...
  sha256sum "$source_root/main/ansible/host_files/snow/subtensor/README.md" "$source_root/main/ansible/host_files/snow/subtensor/vars.yml" "$source_root/main/ansible/tests/test_subtensor_playbook.py"
