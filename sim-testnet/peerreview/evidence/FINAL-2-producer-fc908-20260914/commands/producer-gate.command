...
set -euo pipefail
umask 077
runtime='/home/by/urnetwork/temp/sn-warp-admission-integration-20260913/workspace-physical/terra-runtime/producer-final37-standalone-fc908685-r1'
...
[[ -f "$lock" && ! -L "$lock" && "$(sha256sum "$lock" | awk '{print $1}')" == '76cd7fa7031ee5566301173a94e1a4369ccbc871542de05119b46bbcb1461f35' ]] || exit 125
