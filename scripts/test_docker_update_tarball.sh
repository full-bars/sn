...
test_primary_success() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-1/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_update
...
test_mirror_fallback_success() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-2/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=1
    MOCK_MIRROR_FAIL=0
    unset ec
    run_update
...
test_both_downloads_fail() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-3/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=1
    MOCK_MIRROR_FAIL=1
    unset ec
    run_update
...
test_extraction_fails() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-4/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    MOCK_TAR_FAIL=1
    unset ec
    run_update
...
test_provider_missing_in_tarball() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-5/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
...
test_tarball_name_is_unpredictable() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-6a/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=1
    MOCK_MIRROR_FAIL=1
    unset ec
    run_update
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-6b/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=1
    MOCK_MIRROR_FAIL=1
    unset ec
    run_update
...
test_idle_update_window_zero() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-idle-1/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_idle_update
...
test_idle_update_custom_threshold() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-idle-2/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    out="$(
        MOCK_VERSION="${MOCK_VERSION:-}" \
...
test_zero_byte_tarball_fails_cleanly() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-9/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    MOCK_TARBALL_CONTENT=""
...
test_partial_primary_overwritten_by_mirror() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-9b/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=1
    MOCK_MIRROR_FAIL=0
...
test_marker_removed_on_success() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-10/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_update
...
test_marker_removed_on_mv_failure() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-10b/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
...
test_marker_dir_respects_custom_home() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-10c/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_update
...
test_arch_x86_64_maps_to_amd64() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-11a/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_update
...
test_arch_aarch64_maps_to_arm64() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-11b/urnetwork-linux-arm64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
    run_update
...
test_arch_unsupported_exits_before_side_effects() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-11c/urnetwork-linux-riscv64.tar.gz"
    unset ec
    run_update
...
test_mktemp_stub_catches_staged_provider_regression() {
    ...
    MOCK_DOWNLOAD_URL="https://github.com/full-bars/sn/releases/download/v9.9.9-mock-12/urnetwork-linux-amd64.tar.gz"
    MOCK_PRIMARY_FAIL=0
    unset ec
